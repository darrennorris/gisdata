...
Nós só precisamos de duas dessas camadas. O código abaixo vai carregar os dados que precisamos e criar os objetos "rsm" e "rsl.
...
`r kableExtra::text_spec("Usando os valores conhecidos de raio e área de floresta para os diferentes buffers circulares, calcule a proporção de floresta em cada uma das diferentes extensões de buffer. Apresente os resultados incluindo cálculos e um gráfico com valores de "extensão" no eixo x e proporção da floresta no eixo y. Em menos de 200 palavras apresente sua interpretação do gráfico", color = "blue", bold = TRUE)`
