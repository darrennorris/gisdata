...
Nesta aula vamos entender a importância de escala na ecologia da paisagem através cálculos com a proporção de floresta em escalas diferentes.
1. Carregar dados geoespaciais (raster e vetorial); 
2. Produzir mapas; 
3. Alterar escala (resolução e extensão espacial); 
4. Calcular a área de uma classe de habitat; 
5. Desenvolve uma comparação multiescala.
