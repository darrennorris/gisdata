...
Objetivo não é de apresentar detalhes sobre os cálculos/funções/métodos estatísticas ou de [R](https://cran.r-project.org/).
Mas, sim, o objetivo é  de apresentar um exemplo mostrado os capacidades e opções  de desenvolver e integrar pesquisas cientificas que sao disponibilizados no ambiente estatística de [R](https://cran.r-project.org/)
...
Baixar arquivo com os dados (formato "GPKG", tamanho `r round(fs,1)` MB). Link: [https://github.com/darrennorris/gisdata/blob/master/inst/vector/rivers.GPKG](https://github.com/darrennorris/gisdata/blob/master/inst/vector/rivers.GPKG) .
...
Agora vamos fazer alguns resumos com os dados na tabela de atributos. No arquivo "fl" temos dados mostrando valores de [desmatamento](http://earthenginepartners.appspot.com/science-2013-global-forest) , obtidos de https://earthenginepartners.appspot.com/science-2013-global-forest/download_v1.6.html .
...
Primeiro preciso ajustar os dados para facilitar apresentação visual:
```{r echo=TRUE, message = FALSE}
...
[R-br: a lista Brasileira oficial de discussão do programa R:](http://r-br.2285057.n4.nabble.com/)  http://r-br.2285057.n4.nabble.com/,

[foruns](https://www.facebook.com/rcomputing/) : https://www.facebook.com/rcomputing/ ;
